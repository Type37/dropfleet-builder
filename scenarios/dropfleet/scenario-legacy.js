/* 1st edition Dropfleet scenarios converted to the current edition by WarLore on Jet's call (2026-09-13),
   ...
   - Sectors -> Features (11.3): Military -> Military Outpost, Orbital Defence -> Orbital Defence Gun,
     Power Plant -> Power Plant, Comms Station -> Comms Station, Industrial -> Power Plant (Jet's call,
     2026-09-13). Commercial has no Feature.
...
(function(){
  ...
  add({id:'resistance-spearhead', sizes:true, features:['Military Outpost', 'Power Plant'], name:'Resistance Spearhead', src:'Advent Scenarios (1st edition)',
   ...
   variant:[`Turf War: both players play as Resistance, and every City is replaced with a Medium Space Station.`]});
  ...
  add({id:'core-station-assault', name:'Station Assault', src:'Core Scenarios (1st edition)',
   ...
   variantWeapons:[ARM.mass, ARM.laser, ARM.missile]});
  ...
  add({id:'core-grid-control', sizes:true, features:['Military Outpost', 'Orbital Defence Gun', 'Power Plant'], name:'Grid Control', src:'Core Scenarios (1st edition)',
   ...
   deployment:`All players Staggered, from opposite table edges as shown.`,
   scoring:[`Standard Scoring.`, FOCAL,
            `The two Medium Cities, or the Medium Space Stations that replace them in the Variant, award double Standard Scoring, and their Focal Points double VP.`],
   ...
   variantWeapons:[ARM.laser, ARM.mass]});
  ...
  add({id:'core-defence-relay', sizes:true, features:['Comms Station', 'Military Outpost', 'Power Plant'], name:'Defence Relay', src:'Core Scenarios (1st edition)',
   ...
   variant:[`Surface to Space: replace each Space Station with a Medium City that has an Orbital Defence Gun and 2 Military Outposts. The Space Station Armaments above are not used.`]});
