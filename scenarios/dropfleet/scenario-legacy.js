...
(function(){
  ...
  const CB=`The Dropsites ringed in blue are only used in Clash and Battle sized games.`;
  ...
  add({id:'the-ancient-relic', name:'The Ancient Relic', src:'Automated Dreadnought', leviathan:'Automated Dreadnought',
   ...
   scoring:[`Standard Scoring. Each Space Station is a Medium Space Station.`,
            `A player that Levels a Space Station on their opponent's half of the table gains 4VP.`,
   ...
   leviathanRules:[`The Automated Dreadnought is deployed on the centre line of the table in Orbit, touching a table edge and facing the opposite edge (shown in orange).`,
     ...
     `When the Automated Dreadnought activates, it moves its Thrust along the centre line, then attacks the closest Group as if it were on the Weapons Free order.`,
  ...
  add({id:'resistance-spearhead', name:'Resistance Spearhead', src:'Advent Scenarios',
   ...
   players:`1 attacker, 1 defender. The Resistance player is the attacker.`,
   scenery:DEBRIS,
   ...
   scoring:[`Attacker: Standard Scoring, with every Dropsite scoring as a Medium Dropsite.`,
            `Defender: can only Contest Dropsites, even when they Control them, and every Dropsite scores as a Medium Dropsite. The defender gains 1VP for every enemy Group destroyed, and loses the Demolish Scoring for every Dropsite that is Ruined or Levelled.`],
   special:[CB],
  ...
  add({id:'heavy-convoy', name:'Heavy Convoy', src:'Advent Scenarios',
   ...
   players:`1 attacker, 1 defender. The defender must take 2 Dreadnoughts; the attacker cannot take any. Recommended 1300 points.`,
   scenery:DEBRIS,
   deployment:`All players Staggered, from opposite table edges as shown. The defender must deploy both Dreadnoughts' Groups in the 1st round.`,
   scoring:[`Each Dreadnought that touches the opposite table edge is removed from the game and gains the defender 3VP.`,
  ...
  add({id:'monitoring-the-situation', name:'Monitoring the Situation', src:'Advent Scenarios',
   ...
   scenery:`4 Micrometeor Clouds, 4 Dense Debris Fields, 1 Planetary Ring as shown.`,
   ...
   scoring:[`Attacker: Standard Scoring, and 1VP for every Group of Monitors destroyed.`,
            `Defender: in rounds 4 and 6, the High Scoring of every Dropsite the attacker does not Control, and 1VP for every Group of Monitors that survives until the end of the game.`],
   special:[`The Dropsites ringed in blue are only used in Battle sized games.`,
            `Each round, one of the defender's Groups of Monitors may be given one additional Order at the start of the End Phase.`],
  ...
  add({id:'core-take-and-hold', name:'Take & Hold (1st edition)', src:'Core Scenarios',
   ...
   special:[CB],
   variant:[`Double Down: the two Large Cities either side of the centre City, and their Focal Points, are worth double VP.`]});

  add({id:'core-mixed-engagement', name:'Mixed Engagement', src:'Core Scenarios',
   ...
   special:[`Each Space Station is a Medium Space Station armed with a Laser Armament and a Missile Armament. ${FIRE}`, CB],
   weapons:[ARM.laser, ARM.missile],
   variant:[`Valuable Supplies: the Focal Points on the two Cities are worth double VP.`]});

  add({id:'core-erupting-battlefront', name:'Erupting Battlefront (1st edition)', src:'Core Scenarios',
   ...
   deployment:`All players Staggered, from opposite table edges as shown.`,
   scoring:[`Red player: Demolish Scoring from the B Cities, which are also Focal Points with a range of 6". Standard Scoring from the A Cities.`,
            `Blue player: Demolish Scoring from the A Cities, which are also Focal Points with a range of 6". Standard Scoring from the B Cities.`,
            `Both players: Standard Scoring from the centre City and the Space Stations, which are also Focal Points with a range of 6".`],
   special:[`Each Space Station is a Medium Space Station.`, CB],
   variant:[`Punching Up: the centre City gains 2 Orbital Defence Guns.`]});
  ...
  add({id:'core-grid-control', name:'Grid Control', src:'Core Scenarios',
   ...
   deployment:`All players Staggered, from opposite table edges as shown.`,
   scoring:[`Standard Scoring.`, FOCAL,
            `The Dropsites ringed in blue award double Standard Scoring, and their Focal Points double VP.`],
   special:[CB],
   variant:[`Orbital Installation: replace the centre City with a Large Space Station armed with 4 Laser Armaments, and the Dropsites ringed in blue with Medium Space Stations armed with 2 Mass Driver Armaments each. ${FIRE}`],
   weapons:[ARM.laser, ARM.mass]});

  add({id:'core-power-grab', name:'Power Grab (1st edition)', src:'Core Scenarios',
   ...
   scoring:[`Standard Scoring.`, FOCAL,
            `Cities with a Power Plant award double VP, and none once their Power Plant is destroyed.`],
   variant:[`Bifurcate: use no Micrometeor Clouds or Dense Debris Fields. Place a Planetary Ring through the centre of the table, from the middle of one player's corner side to the other's.`]});

  add({id:'core-defence-relay', name:'Defence Relay', src:'Core Scenarios',
   ...
   scoring:[`Standard Scoring. Each Space Station is a Medium Space Station.`, FOCAL,
            `A player that removes a Comms Station loses 4VP.`,
            `A player gains 5VP at the end of the game for each Dropsite with a Comms Station they Control.`],
   special:[`Each Space Station is armed with a Laser Armament, a Mass Driver Armament and a Missile Armament. ${FIRE}`, CB],
